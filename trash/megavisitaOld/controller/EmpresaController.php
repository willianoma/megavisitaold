...
class EmpresaController {
    ...
    function listar() {
        ...
        include 'view/empresa/ListarEmpresa.php';
    }

    function formAdd() {
        include_once 'view/empresa/CadastroEmpresa.php';
    }

    public function formDelete() {
        $id = $_POST['id'];
        $_REQUEST['empresa'] = $this->empresaDao->getEmpresa($id);
        include_once 'view/empresa/DeletarEmpresa.php';
    }

    public function formEdit() {
        $id = $_POST['id'];
        $_REQUEST['empresa'] = $this->empresaDao->getEmpresa($id);
        include_once 'view/empresa/EditarEmpresa.php';
    }
