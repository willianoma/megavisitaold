...
<form method="POST" action="?controller=Visita&acao=cadastrarVisita">
    <div style="width: auto;">
        ...
        <input type='text' name='var_escondida' hidden="" value='' required="" id='var_escondida'  />
    ...
    <div style="width: auto;">
        ...
        <input type="submit" name="cadastrarVisita" value="Cadastrar Visita" onclick="getLocation()" style="width: 100%; height: 50"/>
    </div>
</form>
<br>
